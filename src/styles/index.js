const styles = {
  ...
  headTitle: "text-white font-poppins font-black text-3xl tracking-wide mb-2",
  ...
  currencyList:
    "absolute z-10 right-0 bg-site-black border-[1px] border-site-dim2 w-full mt-2 rounded-lg min-w-[200px] h-[300px] overflow-y-scroll",
  currencyListItem:
  ...
  // WalletButton
  walletButton:
    "sm:block hidden bg-site-pink border-none outline-none px-6 py-2 font-poppins font-bold text-lg text-white rounded-3xl leading-[24px] hover:bg-pink-600 transition-all",

    // WalletConnectButton
  walletConnectButton:
  "sm:hidden block bg-site-pink border-none outline-none px-6 py-2 font-poppins font-bold text-lg text-white rounded-3xl leading-[24px] hover:bg-pink-600 transition-all",
